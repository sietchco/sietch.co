...
const Home = () => {
  return (
    <Main>
      ...
      <section className="text-ui-white bg-today">
        <div className="container mx-auto py-40 max-sm:pb-28 lg:px-64 max-sm:px-6 xl:pt-64">
          ...
          <div className="flex justify-between text-8xl pt-60 max-md:grid max-md:grid-cols-2 max-md:text-6xl max-md:pt-40">
            <div className="flex flex-col items-center z-0 max-sm:mb-14">
              <Counter from={0} to={9} />
              <span className="text-base mt-6">Years in business</span>
            </div>
            <div className="flex flex-col items-center z-0">
                <Counter from={0} to={80} />
              <span className="text-base mt-6">Builders</span>
            </div>
            <div className="flex flex-col items-center z-0">
                <Counter from={0} to={10} />
              <span className="text-base mt-6">Countries</span>
            </div>
            <div className="flex flex-col items-center z-0">
                <Counter from={0} to={30} />
              <span className="text-base mt-6">Partnerships</span>
            </div>
          </div>
        </div>
      </section>
