          ...
          <div className="container mx-auto py-10 text-ui-black max-sm:px-6 max-sm:py-0 lg:px-16 xl:px-64">
            <section className="pt-24 pb-[60px] max-sm:pb-11">
              <h3 className="text-2xl pb-4 max-sm:text-lg text-ui-gray">
                Sietch is a product strategy and development company.
              </h3>
              <h1 className="md:text-[56px] font-bold leading-[1.2] max-sm:text-[33px] max-sm:pt-5 xl:w-[46rem]">
                We help innovators achieve successful outcomes.
              </h1>
            </section>
            ...
            <div className="text-right max-sm:pt-16 pb-20 max-sm:pb-28">
              <p className="font-semibold max-sm:text-xl md:pt-32 text-2xl">
                "Sietch is not an agency. They’re entrepreneurs like we are."
              </p>
              <p className="pt-4 pb-5">
                —Paul Díaz, President, <span className="link">Sietch</span>
              </p>
        ...
        >
          <div>
            ...
            <div className="text-xl xl:text-[32px] xl:leading-tight">
              Able was founded in 2023 by Paul Díaz, a software engineer and entrepreneur, and
