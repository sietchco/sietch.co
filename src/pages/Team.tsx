    ...
    <div className="text-ui-black bg-white">
      ...
      grid grid-cols-2 gap-32 place-items-center max-md:grid-cols-1 max-md:gap-2">
        ...
        <div>
          ...
          <div className="text-3xl max-md:text-xl">We succeed when we create the conditions for our team to thrive. In addition to a competitive benefits package we also offer a number of perks:</div>
        </div>
      </section>
      ...
      <section className="container mx-auto max-sm:px-6 md:px-14 lg:px-16 xl:px-64 my-40 max-md:my-20">
        <div className="flex">
          ...
          <div className="text-xl">
            ...
            <p>We have offices in Brooklyn, NY and Lima, Peru, but we encourage our team members to work where they are most comfortable and productive.</p>
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="text-xl">
            ...
            <p>Monthly stipends to support personal development and health… oh, and to eat mid-day.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-today text-ui-white mb-[530px] max-md:mb-[340px]">
        <div className="container mx-auto max-sm:px-6 md:px-14 lg:px-16 xl:px-64 py-40 max-md:py-20">
          ...
          <div className="text-[32px] mr-80 max-md:text-center max-md:mr-0 max-md:text-[21px]">Like the broader organization, our leadership team is distributed across North and South America. The team’s diverse backgrounds and expertise are unified by one characteristic: an ambition to build together.</div>
