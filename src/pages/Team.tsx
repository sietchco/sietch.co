    ...
    <Main>
      ...
      <div className="text-ui-black bg-white">
        ...
        <section className="container mx-auto max-sm:px-6 md:px-14 lg:px-16 xl:px-64 py-40 max-md:pt-28 max-md:pb-14">
          ...
          <div className="grid grid-cols-3 gap-32 text-center text-ui-gray max-md:grid-cols-1 max-md:gap-1 snap-center">
      ...
      grid grid-cols-2 gap-32 place-items-center max-md:grid-cols-1 max-md:gap-2"
        >
          <div className='snap-center max-md:snap-start'>
        ...
        <section className="container mx-auto max-sm:px-6 md:px-14 lg:px-16 xl:px-64 my-40 max-md:my-20 snap-center">
        ...
        <section className="bg-gradient-to-b from-[#D8E6F566] to-[#bbd0e63f]">
          <div className="container mx-auto max-sm:px-6 md:px-14 lg:px-16 xl:px-64 py-52 max-md:py-32 snap-center">
