        ...
        <div className="bg-ui-white h-[570px] md:w-[700px] mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-16 max-md:p-8">
            ...
            <div className="pb-5">
              ...
              <select 
                required
                className="ml-1 bg-zinc-100" {...register("typeService", {
                required: true,
              })}>
            ...
            <div className="pb-5">
              ...
              <select
                required
                className="ml-1 bg-zinc-100 my-2" {...register("comesFrom", {
                required: true,
              })}>
            ...
            <div className="pb-4">
              <textarea
                ...
                cols={20} rows={3} {...register("message", {
                required: true,
              })}></textarea>
            </div>
            
            <button type="submit" className="h-16 w-28 border border-solid border-black font-semibold">SEND</button>
          </form>
